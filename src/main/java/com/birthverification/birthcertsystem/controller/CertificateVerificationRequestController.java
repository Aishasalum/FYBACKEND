...
public class CertificateVerificationRequestController {
    ...
    // ✅ Create Verification Request with certificate and send notification
    @PostMapping("/create")
    public ResponseEntity<CertificateVerificationRequest> createRequest(
            @RequestBody CertificateVerificationRequestDTO dto,
            @RequestParam Long uploadedCertificateId
        ...
        try {
            ...
            // Save request
            CertificateVerificationRequest savedRequest = requestService.saveWithCertificate(request);

            // ✅ Send in-app notification to user
            User user = savedRequest.getUser();
            String message = "Your certificate verification request has been submitted successfully.";
            notificationService.sendNotification(user, message, NotificationType.POPUP, savedRequest.getId());
